        ...
        <div class="pax-console-header">
            ...
            <div class="pax-console-header-right">
                ...
                <form method="get" class="pax-console-search-form">
                    ...
                    <button type="submit" class="pax-console-search-btn">
                        <span class="dashicons dashicons-search"></span>
                    </button>
                </form>
                <select class="pax-console-filter" onchange="if(this.value) window.location.href=this.value;">
